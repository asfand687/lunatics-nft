...
const AboutHero = () => {
  return (
    <section className="w-full py-16 max-w-[1300px] px-4 mx-auto flex flex-col lg:flex-row justify-between mb-2">
      <div className="order-2 lg:order-1 flex-1 ">
        <img className="px-4 w-full lg:w-[450px]" src={HeroImg} alt="hero" />
      </div>
      <div className="pb-8 px-4 lg:pb-0 order-1 lg:order-2 flex-1">
