        ...
        <article className="flex-1">
          ...
          <div className=" py-2 space-y-10 h-full">
            <article>
              ...
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">Off The Walls</h2>
            ...
            <article>
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">LUNATICS Store</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
            ...
            <article>
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">3D Collectibles</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
        ...
        <article className="flex-1">
          ...
          <div className="py-2 lg:border-x lg:px-6 lg:h-[1064px] lg:border-[#0300AD] space-y-10">
            <article>
              ...
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">Gen 2 Collection Utility</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
            ...
            <article>
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">Launchpad</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
            ...
            <article>
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">Event Access</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
        ...
        <article className="flex-1">
          ...
          <div className="py-2 space-y-10">
            <article>
              ...
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">Lunatics Dao</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
            ...
            <article>
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">World Of Metaverse</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
            ...
            <article>
              <h2 className="text-muse text-base lg:text-3xl font-normal pb-8">$FAMM</h2>
              <p className="text-base lg:text-lg  leading-9 tracking-[-1.5%]">
